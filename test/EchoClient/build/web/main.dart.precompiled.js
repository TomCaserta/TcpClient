...
["ChromeClientTest", "main.dart", , Z, {
  "^": "",
  main: [function() {
    P.print("Starting");
    var testClient = new O.TcpClient(null, "127.0.0.1", 3738, false);
    P.print("Got here");
    testClient.get$onReceiveError().listen$1(new Z.main_closure());
    testClient.connect$0().then$1(new Z.main_closure0(testClient));
    P.print("Exit");
  }, "call$0", "main$closure", 0, 0, 0],
  main_closure: {
    "^": "Closure:41;",
    call$1: [function(rev) {
      P.print(J.toString$0(rev));
    }, "call$1", null, 2, 0, null, 40, "call"],
    $isFunction: true
  },
  main_closure0: {
    "^": "Closure:43;testClient_0",
    call$1: [function(readyCode) {
      var t1, t2, encoder;
      P.print("Another location!");
      t1 = this.testClient_0;
      new P.LineSplitter().bind$1(new P.Utf8Decoder(false).bind$1(t1.get$onReceive())).listen$1(new Z.main__closure());
      C.Utf8Codec_false.get$encoder();
      t2 = Array(21);
      t2.fixed$length = init;
      t2 = H.setRuntimeTypeInfo(t2, [P.$int]);
      encoder = new P._Utf8Encoder(0, 0, t2);
      if (encoder._fillBuffer$3("Hello!\n", 0, 7) !== 7)
        encoder._writeSurrogate$2(C.JSString_methods.codeUnitAt$1("Hello!\n", 6), 0);
      t1.write$1(C.JSArray_methods.sublist$2(t2, 0, encoder._bufferIndex));
...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "ArrayBuffer|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedNumberList|SVGAnimatedTransformList"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  IsolateNatives__startNonWorker_closure: {
    "^": "Closure:46;box_0,functionName_1,isSpawnUri_2,startPaused_3,replyPort_4",
    call$0: [function() {
      var t1 = this.box_0;
...
["chrome.src.common", "package:chrome/src/common.dart", , F, {
  ...
  ChromeCompleter$oneArg_closure: {
    "^": "Closure:53;this_0,transformer_1",
    ...
    }, "call$0", "call$1", null, null, 0, 2, null, 25, 9, "call"],
    $isFunction: true
  },
  ...
  ChromeStreamController$oneArg_closure: {
    "^": "Closure:53;this_0,transformer_1,returnVal_2",
    call$1: [function(arg1) {
      var t1, t2;
...
["dart.async", "dart:async", , P, {
  ...
  _Future__propagateToListeners_handleValueCallback: {
    "^": "Closure:55;box_1,listener_3,sourceValue_4,zone_5",
    call$0: function() {
  ...
  _StreamController: {
    ...
    }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 59, 25, 26, 27],
    close$0: [function(_) {
      var t1 = this._state;
      if ((t1 & 4) !== 0)
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 62, 26, 27],
  ...
  _SinkTransformerStreamSubscription: {
    ...
    }, "_handleError$1", "call$2", "call$1", "get$_handleError", 2, 2, 63, 25, 26, 27],
    _handleDone$0: [function() {
      var e, s, exception, t1;
      try {
        this._subscription = null;
  ...
  _rootHandleUncaughtError__closure: {
    "^": "Closure:46;error_2,stackTrace_3",
    call$0: function() {
      var t1, trace;
      t1 = this.error_2;
...
["dart.convert", "dart:convert", , P, {
  ...
  _LineSplitterSink: {
    "^": "StringConversionSinkBase;_convert$_sink,_carry",
    ...
    static: {"^": "_LineSplitterSink__LF,_LineSplitterSink__CR", _LineSplitterSink__addSlice: function(chunk, start, end, isLast, adder) {
  ...
  _Utf8Decoder_convert_addSingleBytes: {
    "^": "Closure:68;box_0,this_1,codeUnits_2",
...
["dart.js", "dart:js", , P, {
  ...
  }, "call$1", "_convertToJS$closure", 2, 0, 19, 38],
...
["tcpclient", "packages/tcpclient/tcpclient.dart", , O, {
  "^": "",
  TcpClient: {
    "^": "Object;socketID,address,port,_paused",
    get$onReceive: function() {
      var t1 = $.get$sockets().tcp._onReceive._controller;
      t1 = H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]);
      t1 = H.setRuntimeTypeInfo(new P._WhereStream(new O.TcpClient_onReceive_closure(this), t1), [H.getRuntimeTypeArgument(t1, "Stream", 0)]);
      return H.setRuntimeTypeInfo(new P._StreamSubscriptionTransformer(new O.TcpClient_onReceive_closure0()), [null, null]).bind$1(t1);
    },
    get$onReceiveError: function() {
      var t1 = $.get$sockets().tcp._onReceiveError._controller;
      t1 = H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]);
      return H.setRuntimeTypeInfo(new P._WhereStream(new O.TcpClient_onReceiveError_closure(this), t1), [H.getRuntimeTypeArgument(t1, "Stream", 0)]);
    },
    connect$0: function() {
      var t1, t2, completer;
      t1 = $.get$sockets().tcp;
      ...
      return completer._completer.future.then$1(new O.TcpClient_connect_closure(this));
    },
    _onCreate$1: function(socketID) {
      var t1, t2, completer;
      ...
      J.$index$asx(J.$index$asx(t2, "sockets"), "tcp").callMethod$2("connect", [socketID, this.address, this.port, completer._callback]);
      return completer._completer.future.then$1(new O.TcpClient__onCreate_closure());
    },
    write$1: function(data) {
      ...
      if (t1 != null) {
        t2 = $.get$sockets().tcp;
        t3 = J.$index$asx($.get$context(), "Uint8Array");
        t4 = [];
        C.JSArray_methods.addAll$1(t4, C.JSArray_methods.map$1(data, P._convertToJS$closure()));
        t4 = J.$index$asx(P.JsObject_JsObject(t3, [H.setRuntimeTypeInfo(new P.JsArray(t4), [null])]), "buffer");
        t3 = $.get$chrome();
        ...
        J.$index$asx(J.$index$asx(t3, "sockets"), "tcp").callMethod$2("send", [t1, F.jsify(new Z.ArrayBuffer(t4)), completer._callback]);
        return completer._completer.future;
      } else
        return this._errorFuture$1(new O.SocketNotOpenError());
    },
    pause$0: function(_) {
      return this._setPaused$1(true);
    },
    resume$0: function() {
      return this._setPaused$1(false);
    },
    _errorFuture$1: function(thrown) {
      var c = H.setRuntimeTypeInfo(new P._AsyncCompleter(P._Future$(null)), [null]);
      c.completeError$1(thrown);
      return c.future;
    },
    _setPaused$1: function(shouldPause) {
      ...
      if (t1 != null) {
        ...
        J.$index$asx(J.$index$asx(t3, "sockets"), "tcp").callMethod$2("setPaused", [t1, shouldPause, completer._callback]);
        return completer._completer.future.then$1(new O.TcpClient__setPaused_closure(this, shouldPause));
      } else
        return this._errorFuture$1(new O.SocketNotOpenError());
    }
  },
  TcpClient_onReceive_closure: {
    "^": "Closure:72;this_0",
    call$1: function(recinf) {
      return J.$eq(recinf.get$socketId(), this.this_0.socketID);
    },
    $isFunction: true
  },
  TcpClient_onReceive_closure0: {
    "^": "Closure:75;",
    call$2: [function(input, cancelOnError) {
      var sc = P.StreamController_StreamController(null, null, null, null, false, null);
      input.listen$3$onDone$onError(new O.TcpClient_onReceive__closure(sc), sc.get$close(sc), sc.get$addError());
      return H.setRuntimeTypeInfo(new P._ControllerStream(sc), [null]).listen$1(null);
    }, "call$2", null, 4, 0, null, 73, 74, "call"],
    $isFunction: true
  },
  TcpClient_onReceive__closure: {
    "^": "Closure:72;sc_1",
    call$1: [function(ri) {
      var t1, t2, t3;
      t1 = this.sc_1;
      t2 = J.get$data$x(ri).getBytes$0();
      if (t1._state >= 4)
  ...
  TcpClient_onReceiveError_closure: {
    "^": "Closure:41;this_0",
    call$1: function(rei) {
      return J.$eq(rei.get$socketId(), this.this_0.socketID);
    },
    $isFunction: true
  },
  TcpClient_connect_closure: {
    "^": "Closure:78;this_0",
    call$1: [function(ci) {
      return this.this_0._onCreate$1(ci.get$socketId());
    }, "call$1", null, 2, 0, null, 77, "call"],
    $isFunction: true
  },
  TcpClient__onCreate_closure: {
    "^": "Closure:19;",
    call$1: [function(value) {
      if (J.$ge$n(value, 0))
        return value;
      else
        throw H.wrapException(O.SocketConnectNetworkError$(value));
    }, "call$1", null, 2, 0, null, 23, "call"],
    $isFunction: true
  },
  TcpClient__setPaused_closure: {
    "^": "Closure:19;this_0,shouldPause_1",
    call$1: [function(s) {
      this.this_0._paused = this.shouldPause_1;
  ...
  NetworkError: {
    "^": "Object;",
    toString$0: function(_) {
      return "Network Error: " + H.S(this.resultCode);
    }
  },
  SocketConnectNetworkError: {
    "^": "NetworkError;resultCode",
    static: {SocketConnectNetworkError$: function(resultCode) {
        return new O.SocketConnectNetworkError(resultCode);
      }}
  },
  SocketNotOpenError: {
    "^": "Error;",
    toString$0: function(_) {
      return "Cannot write to unopened socket";
    }
  }
}],
]);
...
"input",
"cancelOnError",
{func: "dynamic__Stream_bool", args: [[P.Stream, A.ReceiveInfo], P.bool]},
"ri",
"ci",
...
function dart_precompiled($collectedClasses) {
  ...
  function main_closure0(testClient_0) {
    this.testClient_0 = testClient_0;
  }
  ...
  function TcpClient(socketID, address, port, _paused) {
    this.socketID = socketID;
